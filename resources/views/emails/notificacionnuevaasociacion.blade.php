...
<body style="box-sizing: border-box; position: relative; -webkit-text-size-adjust: none; color: #718096; height: 100%; line-height: 1.4; width: 100% !important; margin: 0; padding: 0; border: 1px solid #edf2f7;">
    ...
    <main style="background-color: #ffffff; border-radius: 2px; box-shadow: 0 2px 0 rgba(0, 0, 150, 0.025), 2px 4px 0 rgba(0, 0, 150, 0.015); width: 570px; margin: 0 auto; border: 1px solid #e8e5ef;">
        <h1 style="color: #3d4852; font-size: 18px; font-weight: bold; margin-top: 0;" align="left">Se ha creado una nueva asociación en ARM</h1>

        <p style="line-height: 1.5em; font-size: 16px; margin-top: 0;" align="left">La asociación <strong>{{ $asociacion->nombre }}</strong> se ha unido a la familia de ARM. A partir de ahora, podrás ver toda la información de esta asociación en nuestra página web.</p>

        <a href="{{ $url }}" style="color: #fff; text-align: center; width: 30%; border-radius: 4px; display: inline-block; overflow: hidden; text-decoration: none; background-color: #2d3748; margin: 30px auto; padding: 0; border: 8px solid #2d3748;">Ver las asociaciones</a>
    </main>
