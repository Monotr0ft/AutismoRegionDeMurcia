...
<div>
    <div class="my-5 text-center">
        <h2>Editar Asociación {{ $asociacion->nombre }}</h2>
    </div>
    <div class="row">
        <div class="col-12 col-md-4"></div>
        <div class="col-12 col-md-4">
            <form action="{{ route('dashboard.asociaciones.edit', $asociacion->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <br>
                <div class="form-check mb-3">
                    <input type="checkbox" class="form-check-input" id="publicar" name="publicar" value="1" @if ($asociacion->publicar == 1) checked @endif>
                    <label for="publicar" class="form-check-label">¿Está publicada?</label>
                </div>
                <br>
