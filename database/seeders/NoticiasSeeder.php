...
class NoticiasSeeder extends Seeder
{
    ...
    private $noticias = [
        [
            ...
            'url' => 'https://www.laopiniondemurcia.es/sociedad/2024/04/02/derechos-sociales-impulsa-primer-plan-100539383.html',
            'fecha' => '2024-04-02'
        ],
        [
            'titulo' => 'Una de cada 100 personas en la Región de Murcia tiene un trastorno del espectro autista',
            'url' => 'https://www.orm.es/noticias-2024/una-de-cada-100-personas-en-la-region-de-murcia-tiene-un-trastorno-del-espectro-autista/',
            'fecha' => '2024-04-02'
        ]
    ];
}
