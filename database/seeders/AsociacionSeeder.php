...
class AsociacionSeeder extends Seeder
{
    ...
    private $asociaciones = [
        ...
        [
            'nombre' => 'ASPERMUR',
            'tipo' => 'Asociación',
            'direccion' => 'Calle Ermita vieja, 31, 30006, Puente Tocinos, Murcia (Región De Murcia)',
            'telefono' => 639966880,
        ...
        [
            'nombre' => 'ASTEAMUR',
            'tipo' => 'Asociación',
            'direccion' => 'Calle Greco, 5, 30006, Murcia (Región De Murcia)',
            'telefono' => 868661952,
